      ...
      >
        <div className="sticky top-0 bg-white border-b border-gray-100 px-6 py-4 flex items-center justify-between">
          <h2 className="text-2xl font-semibold">
            {translations[language].privacyTitle}
          </h2>
          <button
            onClick={onClose}
        ...
        <div id="privacy-content" className="px-6 py-8">
          <p className="text-gray-500 mb-8">
            {translations[language].privacyLastUpdated}
          </p>
...
privacy"
          ...
          <p>
            ...
            Limited, Merrion Road, Dublin 4, D04 X2K5, Irland. Die erfassten
